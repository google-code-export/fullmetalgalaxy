 ...
 *
 * The following interface have to be implemented by any automatic player, ie AI.
 */
public interface AutomaticPlayer
{
  /**
   * This method is called an undefined time number when given EbRegistration can play.
   * 
   * @param p_game
   * @return
   */
